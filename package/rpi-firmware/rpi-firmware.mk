...
RPI_FIRMWARE_AUTOBOOT_FILE = $(call qstrip,$(BR2_PACKAGE_RPI_FIRMWARE_AUTOBOOT_FILE))
ifneq ($(RPI_FIRMWARE_AUTOBOOT_FILE),)
define RPI_FIRMWARE_INSTALL_AUTOBOOT
	$(INSTALL) -D -m 0644 $(RPI_FIRMWARE_AUTOBOOT_FILE) \
		$(BINARIES_DIR)/rpi-firmware/autoboot.txt
endef
endif
...
RPI_FIRMWARE_AB_CMDLINE_FILES = $(call qstrip,$(BR2_PACKAGE_RPI_FIRMWARE_AB_CMDLINE_FILES))
ifneq ($(RPI_FIRMWARE_AB_CMDLINE_FILES),)
define RPI_FIRMWARE_INSTALL_AB_CMDLINES
        $(foreach f,$(RPI_FIRMWARE_AB_CMDLINE_FILES), \
                $(INSTALL) -D -m 0644 $(f) $(BINARIES_DIR)/rpi-firmware/$(notdir $(f))
        )
endef
endif

RPI_FIRMWARE_AB_AUTOBOOT_FILES = $(call qstrip,$(BR2_PACKAGE_RPI_FIRMWARE_AB_AUTOBOOT_FILES))
ifeq ($(words $(RPI_FIRMWARE_AB_AUTOBOOT_FILES)), 1)
define RPI_FIRMWARE_INSTALL_AB_AUTOBOOTS
	$(INSTALL) -D -m 0644 $(firstword $(RPI_FIRMWARE_AB_AUTOBOOT_FILES)) $(BINARIES_DIR)/rpi-firmware/autoboot.txt
endef
endif
ifeq ($(words $(RPI_FIRMWARE_AB_AUTOBOOT_FILES)), 2)
define RPI_FIRMWARE_INSTALL_AB_AUTOBOOTS
	$(INSTALL) -D -m 0644 $(firstword $(RPI_FIRMWARE_AB_AUTOBOOT_FILES)) $(BINARIES_DIR)/rpi-firmware/autoboot.txt
	$(INSTALL) -D -m 0644 $(word 2,$(RPI_FIRMWARE_AB_AUTOBOOT_FILES)) $(BINARIES_DIR)/rpi-firmware/autoboot_alt.txt
endef
endif
...
define RPI_FIRMWARE_INSTALL_IMAGES_CMDS
	$(RPI_FIRMWARE_INSTALL_AUTOBOOT)
	$(RPI_FIRMWARE_INSTALL_BIN)
	$(RPI_FIRMWARE_INSTALL_CONFIG)
	$(RPI_FIRMWARE_INSTALL_CMDLINE)
	$(RPI_FIRMWARE_INSTALL_AB_CMDLINES)
	$(RPI_FIRMWARE_INSTALL_AB_AUTOBOOTS)
